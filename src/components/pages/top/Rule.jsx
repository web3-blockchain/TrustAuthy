  ...
  return (
    <section id="rule" className="p-rule u-mt--110 u-mt--80-sp">
      <div className="p-rule__inner">
        <h2 className="c-text--h2-ttl">Game Mechanics & Victory Conditions</h2>
        ...
        <div className="p-rule__howto u-mt--60 u-mt--40-sp">
          ...
          <p className="c-text u-mt--30 u-mt--20-sp">
            ...
            <br />
            The victors enjoy the lion's share of the rewards. Prepare to join
            the battleground where your reactions are your arsenal!
          </p>
        </div>
      </div>
    </section>
